...
if IS_DEVELOPMENT:
    ...
    TILE_CACHE_TTL = (
        None  # Server cache TTL may be overridden to short-lived in tile_cache
    )
...
BASE_MAP_PATHS = [BASE_MAPS_DIR / "usa-complete.mbtiles"]
...
ENABLE_DIAGNOSTICS = os.getenv("ENABLE_DIAGNOSTICS", "false").lower() in (
    "1",
    "true",
    "yes",
)
