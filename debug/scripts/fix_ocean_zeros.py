...
with open(tiles_v1_path, 'r') as f:
    lines = f.readlines()
...
for i, line in enumerate(lines):
    if "nodata_mask = (elevation_data == NODATA_VALUE)" in line:
        ...
        lines[i] = "        # Also treat exact zeros as NODATA (ocean areas with bad data)\n"
        lines[i] += "        nodata_mask = (elevation_data == NODATA_VALUE) | (elevation_data == 0) | (elevation_data < -500) | (elevation_data > 9000)\n"
