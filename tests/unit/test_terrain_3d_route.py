...
def test_terrain_3d_routes_are_served(monkeypatch):
    ...
    assert "static/js/terrain-3d-math.js?v=20260517o" in response.text
    assert "static/js/terrain-3d-basemap.js?v=20260517o" in response.text
    assert "static/js/terrain-3d.js?v=20260517o" in response.text
