...
def test_terrain_3d_routes_are_served(monkeypatch):
    ...
    assert "static/js/terrain-3d-math.js?v=20260517y" in response.text
    assert "static/js/terrain-3d-world.js?v=20260517y" in response.text
    assert "static/js/terrain-3d-flood-player.js?v=20260517y" in response.text
    assert "static/js/terrain-3d-basemap.js?v=20260517y" in response.text
    assert "static/js/terrain-3d.js?v=20260517y" in response.text
