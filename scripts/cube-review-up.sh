...
wait_for_status "${API_URL}/api/v2/terrain/hand/sample?lat=33.5186&lng=-86.8104" "200" "HAND sample"
wait_for_status "${API_URL}/api/v2/terrain/hand/${DATASET_VERSION}/11/530/821.u16" "200" "HAND tile"
echo "review URL: ${API_URL}/?lat=33.5186&lng=-86.8104&zoom=11&view=hand&water=2.0"
echo "log: ${LOG_FILE}"
