...
def main():
    parser = argparse.ArgumentParser(description="Audit elevation tile coverage over a bbox")
    parser.add_argument('--z', type=int, required=True, help='Zoom level (e.g., 10-13 for coastal debug)')
