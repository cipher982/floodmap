...
sample_locations = [
    ...
    (29.7604, -95.3698), (25.7617, -80.1918), (47.6062, -122.3321),
    (33.4484, -112.0740), (39.7392, -104.9903), (32.7767, -96.7970),
    (42.3601, -71.0589), (36.1627, -86.7816), (35.2271, -80.8431),
    (30.2672, -97.7431), (39.9526, -75.1652), (26.1224, -80.1373),
    (45.5152, -122.6784), (37.7749, -122.4194), (32.2226, -110.9747),
    (35.0853, -106.6056), (44.9778, -93.2650)
]
...
for zoom in zoom_levels:
    ...
    for lat, lon in sample_locations:
        ...
        overlapping_files = elevation_loader.find_elevation_files_for_tile(lat_top, lat_bottom, lon_left, lon_right)
        ...
        if overlapping_files:
            ...
            if tile_data and len(tile_data) > 0:
                ...
                if tiles_generated % 50 == 0:
                    ...
                    print(f"Generated {tiles_generated} tiles for zoom {zoom} ({elapsed:.1f}s elapsed)")
...
print(f"VPS generation complete! Generated {len(generated_tiles)} tiles in {elapsed_total:.1f} seconds")